...
const TokenDetails = () => {
  ...
  const info = [
    ...
    { title: t("token.max_supply"), value: "9,000,000,210" },
    { title: t("token.pair"), value: "TBI\\WPLS" },
    { title: t("token.decimals"), value: "18" },
    { title: t("token.type"), value: "PRC-20 Standard" },
    { title: t("token.blockchain"), value: "Pulsechain" },
    { title: t("token.tax"), value: "0% - 0%" },
  ];
  const onCopy = () => {
